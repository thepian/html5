...
class shortcodesGenerator extends optionGenerator {
	...
	function upload($value) {
		...
		echo $value['default'];
		echo '" /><div class="theme-upload-buttons"><a class="thickbox button theme-upload-button" id="' . $value['id'] . '" href="media-upload.php?&post_id='.$postid.'&target=' . $value['id'] . '&option_image_upload=1&type=image&TB_iframe=1&width=640&height=644">'.$button.'</a></div>';
		echo '</td></tr>';
	}
