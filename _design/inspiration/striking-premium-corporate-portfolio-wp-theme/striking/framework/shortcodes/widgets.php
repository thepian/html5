...
<div class="contact_form_wrap">
	...
	<form class="contact_form" action="{$include_path}/sendmail.php" method="post" novalidate="novalidate">
		...
		<p><button type="submit" class="button white"><span>{$submit_str}</span></button></p>
