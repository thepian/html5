...
function theme_shortcode_blog($atts, $content = null, $code) {
	...
	switch($column){
		case '2':	
			$output = '<div class="one_half">'.theme_shortcode_blog_column_posts($r,$atts,1).'</div><div class="one_half last">'.theme_shortcode_blog_column_posts($r,$atts,2).'</div><div class="clearboth"></div>';
			break;
		case '3':
			$output = '<div class="one_third">'.theme_shortcode_blog_column_posts($r,$atts,1).'</div><div class="one_third">'.theme_shortcode_blog_column_posts($r,$atts,2).'</div><div class="one_third last">'.theme_shortcode_blog_column_posts($r,$atts,3).'</div><div class="clearboth"></div>';
			break;
		case '4':
			$output = '<div class="one_fourth">'.theme_shortcode_blog_column_posts($r,$atts,1).'</div><div class="one_fourth">'.theme_shortcode_blog_column_posts($r,$atts,2).'</div><div class="one_fourth">'.theme_shortcode_blog_column_posts($r,$atts,3).'</div><div class="one_fourth last">'.theme_shortcode_blog_column_posts($r,$atts,4).'</div><div class="clearboth"></div>';
			break;
		case '5':
			$output = '<div class="one_fifth">'.theme_shortcode_blog_column_posts($r,$atts,1).'</div><div class="one_fifth">'.theme_shortcode_blog_column_posts($r,$atts,2).'</div><div class="one_fifth">'.theme_shortcode_blog_column_posts($r,$atts,3).'</div><div class="one_fifth">'.theme_shortcode_blog_column_posts($r,$atts,4).'</div><div class="one_fifth last">'.theme_shortcode_blog_column_posts($r,$atts,5).'</div><div class="clearboth"></div>';
			break;
		case '6':
			$output = '<div class="one_sixth">'.theme_shortcode_blog_column_posts($r,$atts,1).'</div><div class="one_sixth">'.theme_shortcode_blog_column_posts($r,$atts,2).'</div><div class="one_sixth">'.theme_shortcode_blog_column_posts($r,$atts,3).'</div><div class="one_sixth">'.theme_shortcode_blog_column_posts($r,$atts,4).'</div><div class="one_sixth">'.theme_shortcode_blog_column_posts($r,$atts,5).'</div><div class="one_sixth last">'.theme_shortcode_blog_column_posts($r,$atts,6).'</div><div class="clearboth"></div>';
			break;
		case '1':
		default:
