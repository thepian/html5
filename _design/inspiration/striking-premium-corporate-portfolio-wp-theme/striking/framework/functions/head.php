...
function theme_enqueue_scripts() {
	...
	wp_enqueue_script( 'jquery-colorbox', THEME_JS .'/jquery.colorbox-min.js', array('jquery'),'1.3.16',$move_bottom);
	...
	wp_register_script('jquery-nivo', THEME_JS . '/jquery.nivo.slider.pack.js', array('jquery'),'2.4',$move_bottom);
	...
	wp_register_script('jquery-anything', THEME_JS . '/jquery.anythingslider.js', array('jquery'),'1.5.7.3',$move_bottom);
	...
	if( is_front_page() || (is_home() && !get_option( 'page_on_front' )) || is_single() || is_page() ){
