...
$options = array(
	...
	array(
		...
		array(
			"name" => __("Top Level Menu Active Background Color",'striking_admin'),
			"desc" => "",
	...
	array(
		...
		array(
			"name" => __("Portfolio Sortable Header Active Background Color",'striking_admin'),
			"desc" => "",
		...
		array(
			"name" => __("Portfolio Sortable Header Active Text Color",'striking_admin'),
			"desc" => "",
